...
| --- | --- | ---: | --- | --- |
| Zebra | function | 12-14 | high | Current-line Git evidence: commits=1; lines=3; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Method | method | 19-25 | high | Current-line Git evidence: commits=1; lines=7; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Alpha | other | 5-8 | high | Current-line Git evidence: commits=1; lines=4; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Beta | other | 5-8 | high | Current-line Git evidence: commits=1; lines=4; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Gamma | variable | 10-10 | high | Current-line Git evidence: commits=1; lines=1; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Runner | type | 17-17 | high | Current-line Git evidence: commits=1; lines=1; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| Service | type | 16-16 | high | Current-line Git evidence: commits=1; lines=1; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
| symbols | module | 1-1 | high | Current-line Git evidence: commits=1; lines=1; unblamable=0; freshness=fresh; failure=ok; confidence=high; caveats=none |
