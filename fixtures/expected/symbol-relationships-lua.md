...
- Relation records: 16
- Shown records: 6
- Records hidden by human display limit: 10
- Human display limit: 6 (explicit)
...
- Relationship evidence summary: emitted=16 kinds=contains:9,reference:1,call:2,unknown:2,unresolved:2 unknown=2 unresolved=2 unresolved_targets=5 human_display_sample_omitted=10
