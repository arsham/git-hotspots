...
- Relation records: 25
- Shown records: 6
- Records hidden by human display limit: 19
- Human display limit: 6 (explicit)
...
- Relationship evidence summary: emitted=25 kinds=contains:13,call:2,unknown:7,unresolved:3 unknown=7 unresolved=3 unresolved_targets=10 human_display_sample_omitted=19
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:EXPORTED\_FLAG:other | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:LocalWorker:class | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:Mode:type | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:Tools:type | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:UserId:type | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
| contains | source_to_target | file:src/example.ts | symbol:src/example.ts:UserShape:type | false | tree\-sitter\-typescript\-relations | working\-tree:src/example.ts | fresh | ok | medium | typescript definition containment | C1, C2, C3, C4 |
