...
"$EXE" --repo fixtures/typescript-symbols --inspect src/example.ts --symbols --symbol-line-history --format json > /tmp/git-hotspots-typescript-line-history-deferred.json
! grep -Fq -- 'current_line_history' /tmp/git-hotspots-typescript-line-history-deferred.json
"$EXE" --repo fixtures/typescript-symbols --inspect src/component.tsx --symbols --symbol-line-history --format json > /tmp/git-hotspots-typescript-line-history-tsx-deferred.json
! grep -Fq -- 'current_line_history' /tmp/git-hotspots-typescript-line-history-tsx-deferred.json
python3 - /tmp/git-hotspots-typescript-symbols.json /tmp/git-hotspots-typescript-symbols-limit.json /tmp/git-hotspots-typescript-symbols-tsx.json /tmp/git-hotspots-typescript-symbols-module.json /tmp/git-hotspots-typescript-symbols-common.json /tmp/git-hotspots-typescript-symbols-empty.json /tmp/git-hotspots-typescript-symbols-invalid.json /tmp/git-hotspots-typescript-symbols-generated.json /tmp/git-hotspots-typescript-symbols-symlink-unavailable.json /tmp/git-hotspots-typescript-symbols-large-unavailable.json /tmp/git-hotspots-typescript-symbols-missing-unavailable.json /tmp/git-hotspots-typescript-symbols-rename-alias.json /tmp/git-hotspots-typescript-symbols-other.json /tmp/git-hotspots-typescript-line-history-deferred.json /tmp/git-hotspots-typescript-line-history-tsx-deferred.json <<'PY'
import json, sys
ts, limited, tsx, module, common, empty, invalid, generated, symlink, large, missing, alias, other, line_ts, line_tsx = [json.load(open(path, encoding='utf-8')) for path in sys.argv[1:]]
