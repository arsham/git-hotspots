...
for data in (line, line_shallow, line_partial, line_commonjs, line_jsx, line_anonymous, line_empty, line_invalid, line_generated, line_symlink, line_large, line_missing, line_alias, line_dirty, line_unrelated):
    ...
    for forbidden in ('Fixture Author', 'fixture@example', 'source line', 'ownership', 'productivity', 'Node package graph'):
        assert forbidden not in text
PY
! grep -Eiq -- 'Fixture Author|fixture@example|fixture function|private|file://|raw blame|source line|previous filename|ownership|productivity|developer ranking' /tmp/git-hotspots-javascript-symbols.json /tmp/git-hotspots-javascript-symbols.md /tmp/git-hotspots-javascript-symbols.txt /tmp/git-hotspots-javascript-symbols-limit.json /tmp/git-hotspots-javascript-symbols-limit.md /tmp/git-hotspots-javascript-symbols-limit.txt /tmp/git-hotspots-javascript-symbols-commonjs.json /tmp/git-hotspots-javascript-symbols-jsx.json /tmp/git-hotspots-javascript-symbols-anonymous.json /tmp/git-hotspots-javascript-symbols-empty.json /tmp/git-hotspots-javascript-symbols-invalid.json /tmp/git-hotspots-javascript-symbols-generated.json /tmp/git-hotspots-javascript-symbols-symlink-unavailable.json /tmp/git-hotspots-javascript-symbols-large-unavailable.json /tmp/git-hotspots-javascript-symbols-missing-unavailable.json /tmp/git-hotspots-javascript-symbols-rename-alias.json /tmp/git-hotspots-javascript-symbols-other.json fixtures/expected/javascript-symbols.json fixtures/expected/javascript-symbols.md fixtures/expected/javascript-symbols.txt fixtures/expected/javascript-symbols-limit.json fixtures/expected/javascript-symbols-limit.md fixtures/expected/javascript-symbols-limit.txt fixtures/expected/javascript-symbols-commonjs.json fixtures/expected/javascript-symbols-jsx.json fixtures/expected/javascript-symbols-anonymous.json fixtures/expected/javascript-symbols-empty.json fixtures/expected/javascript-symbols-invalid.json fixtures/expected/javascript-symbols-generated.json fixtures/expected/javascript-symbols-symlink-unavailable.json fixtures/expected/javascript-symbols-large-unavailable.json fixtures/expected/javascript-symbols-missing-unavailable.json fixtures/expected/javascript-symbols-rename-alias.json fixtures/expected/javascript-line-history-success.json fixtures/expected/javascript-line-history-success.md fixtures/expected/javascript-line-history-success.txt
