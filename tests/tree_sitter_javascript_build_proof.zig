...
pub fn main() !void {
    ...
    if (!c.ts_parser_set_language(parser, tree_sitter_javascript())) return error.LanguageAssignmentFailed;

    try parseAndAssert(parser, "function proof() { return 1; }\n", "program", "function_declaration");
    try parseAndAssert(parser, "const view = <main id=\"proof\">ok</main>;\n", "program", "lexical_declaration");
}
