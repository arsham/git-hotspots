...
pub const usage =
    ...
    \\  retained ranked-file candidates in Zig, Go, Python, JavaScript, Lua,
    \\  Rust, TypeScript, and TSX lanes only; unsupported current files have
    \\  no public relationship support. It is caveated syntax/provider evidence,
